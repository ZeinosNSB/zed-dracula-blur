...
; TypeScript Enhanced Import Highlighting
; Global Import Keywords & Source
(import_statement
  source: (string) @import.side_effect
  (#not-has-child? import_clause))
...
; Inline type import: import { type User }
(import_statement
  (import_clause
    (named_imports
      (import_specifier
